...
class TicTacToeBoard():
    def __init__(self):
        ...
        #added to get the row and column
        self.aux_row=0
        self.aux_column=0
    ...
    def menu_bar(self):  
      ...
      #  editmenu.add_command(label = "New invoice", command = self.donothing)
      #  editmenu.add_separator()
      #  menubar.add_cascade(label = "Add", menu = editmenu)

        #editmenu = tk.Menu(menubar, tearoff=0)
        # editmenu.add_command(label = "1-Modify text", command = self.modify_text)
        # editmenu.add_separator()
        # editmenu.add_command(label = "2-Get inovice's items desc", command = self.invoice_description)
        # editmenu.add_command(label = "3-Modify table", command = self.modify_table)
    ...
    def update_counter(self):
        ...
        x_human=(self.human_counter.winfo_width()-lb_human.winfo_width())/2
        y_human=(self.human_counter.winfo_height()-lb_human.winfo_height())/2
